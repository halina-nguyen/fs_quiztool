...
class TrackdriveTab:
    ...
    def setup_ui(self):
        ...
        calculate_button = tk.Button(self.tab, text="Calculate Acceleration", command=self.calculate_trackdrive)
        calculate_button.grid(row=7, column=0, columnspan=10, pady=10)

        self.score_trachdrive = tk.Label(self.tab, text="")
        self.score_trachdrive.grid(row=8, column=0, columnspan=10, pady=10)