...
class CostTab:
    ...
    def setup_ui(self):
        note = tk.Label(self.tab, text="Just for non-finalist.\nFor finalist, team's score = Cost and Manufacturing score")
        ...
        calculate_button = tk.Button(self.tab, text="Calculate Cost and Manufacturing", command=self.calculate_cost)
